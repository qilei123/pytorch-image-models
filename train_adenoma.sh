...
#root_dir=/data3/qilei_chen/DATA/polyp_xinzi/D1_D2
output_dir=$root_dir/work_dir #_balanced
num_class=2
...
python train.py $root_dir --model resnext50_32x4d --pretrained --num-classes $num_class --output $output_dir -b 64 --dataset Adenoma --val-split test #--use_balanced_sampler
...
# python train.py $root_dir --model swin_base_patch4_window7_224 --pretrained --num-classes $num_class --output $output_dir -b 64 --dataset Adenoma --val-split test  --use_balanced_sampler
