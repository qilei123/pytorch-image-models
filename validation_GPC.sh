...
checkpoint_dir=$output_dir/xcit_small_12_p8_224-224/model_best.pth.tar
python validate.py $data_dir --model $model_name --num-classes $num_classes --checkpoint $checkpoint_dir -b $batch_size --confusion-matrix
