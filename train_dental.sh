...
num_class=2
output_dir=$root_dir/work_dir_seg_weight_caries
python train.py $root_dir --model resnext50_32x4d --pretrained --num-classes $num_class --output $output_dir -b 128 --dataset segdental --val-split test --use_balanced_sampler
#python train.py $root_dir --model swin_base_patch4_window7_224 --pretrained --num-classes $num_class --output $output_dir -b 32 --dataset segdental --val-split test

#output_dir=$root_dir/work_dir_balance_seg
#python train.py $root_dir --model resnext50_32x4d --pretrained --num-classes $num_class --output $output_dir -b 64 --dataset segdental --val-split test --use_balanced_sampler --resume $output_dir/resnext50_32x4d-224/last.pth.tar
#python train.py $root_dir --model swin_base_patch4_window7_224 --pretrained --num-classes $num_class --output $output_dir -b 32 --dataset segdental --val-split test --use_balanced_sampler
